...
It assumes a 2-level tier structure in cell/. Each pl file there is 
an organism file, and its organism has a number of mutually
exclusive cell files in the homonym sub directory with cell.

For example all .pl files cell/hs/ are all the sub-parts comprising
cell/hs.pl.
