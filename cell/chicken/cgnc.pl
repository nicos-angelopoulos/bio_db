:- module( bio_db_gallus_cgnc, [
                bio_db_gallus_cgnc/0,
                    %       + CGNC ids to:
                map_cgnc_gallus_cgnc_curs/2,   % -> curation status
                map_cgnc_gallus_cgnc_edat/2,   % -> last edit date
                map_cgnc_gallus_cgnc_entz/2,   % -> entrez id
                map_cgnc_gallus_cgnc_ensg/2,   % -> ensembl gene
                map_cgnc_gallus_cgnc_name/2,   % -> name (text describing)
                map_cgnc_gallus_cgnc_symb/2,   % -> symbol (short, compact name)
                map_cgnc_gallus_cgnc_syno/2    % -> known synonym
                ] ).
