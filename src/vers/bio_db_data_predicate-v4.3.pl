...
%    * ncbi_suss_ncbi_ensp/2
%
% Generated on 23.10.01 from bio_db with pack.pl version: 4.2.
% 
%
...
bio_db_data_predicate(reac_galg_ncbi_reap, 2, chicken, 'galg/reac.pl').
...
bio_db_data_predicate(ncbi_homs_ensg_ncbi, 2, human, 'homs/ncbi.pl').
bio_db_data_predicate(ncbi_homs_ensp_ncbi, 2, human, 'homs/ncbi.pl').
...
bio_db_data_predicate(reac_homs_ncbi_reap, 2, human, 'homs/reac.pl').
...
bio_db_data_predicate(mgim_musm_mrks_mnme, 2, mouse, 'musm/mgim.pl').
bio_db_data_predicate(mgim_musm_msyn_mgim, 2, mouse, 'musm/mgim.pl').
bio_db_data_predicate(mgim_musm_symb_wdra, 2, mouse, 'musm/mgim.pl').
...
bio_db_data_predicate(ncbi_suss_ncbi_ensg, 2, pig, 'suss/vgnc.pl').
bio_db_data_predicate(ncbi_suss_ncbi_ensp, 2, pig, 'suss/vgnc.pl').
