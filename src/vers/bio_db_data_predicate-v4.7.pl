...
%
% Generated on 25.03.28 from bio_db with pack.pl version: 4.7.
% 
%
...
bio_db_data_predicate(ense_gg7w_ensg_chrl, 5, chicken, 'galg/ense.pl').
bio_db_data_predicate(ense_gg7w_ensg_symb, 2, chicken, 'galg/ense.pl').
bio_db_data_predicate(ense_gg7w_enst_chrl, 5, chicken, 'galg/ense.pl').
bio_db_data_predicate(ense_gg7w_enst_ensg, 2, chicken, 'galg/ense.pl').
...
bio_db_data_predicate(reac_musm_ncbi_reap, 3, mouse, 'musm/reac.pl').
...
bio_db_data_predicate(reac_suss_ncbi_reac, 2, pig, 'suss/reac.pl').
bio_db_data_predicate(reac_suss_ncbi_reap, 3, pig, 'suss/reac.pl').
bio_db_data_predicate(reac_suss_reac_reap, 3, pig, 'suss/reac.pl').
bio_db_data_predicate(reac_suss_reac_recl, 2, pig, 'suss/reac.pl').
bio_db_data_predicate(reac_suss_reac_recn, 2, pig, 'suss/reac.pl').
bio_db_data_predicate(reac_suss_reap_repn, 2, pig, 'suss/reac.pl').
